...
<html lang="fr">
	<head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="K-PROJECT/images/coffee-cup.svg"/>
	...
	<body >			
			...
			<div class="top-dish-area section-gap">
				<?php
					...
					include_once(DOSSIER_BASE_INCLUDE.'vues/inclusions/formulaireConnexion.inc.php');
				?>
			</div>
	</body>
</html>
